...
-(void)registerButtonClicked:(id)sender{
    if (nil!=self.delegate&&[self.delegate respondsToSelector:@selector(willTransToRegisterViewContrller:)]) {
        [self.delegate willTransToRegisterViewContrller:self];
    }
}
- (IBAction)qqLoginButtonClicked:(id)sender {
}
- (IBAction)weiboLoginButtonClicked:(id)sender {
}
...
-(void)initSubViewsValue{

    UIBarButtonItem*registerItem=[[UIBarButtonItem alloc]initWithTitle:NSLocalizedString(@"Register", nil) style:UIBarButtonItemStylePlain target:self action:@selector(registerButtonClicked:)];
