...
- (void)setupView {
    ...
    // Decoration.
    [self.gradientView setImage:[UIImage imageNamed:@"background-gradient"]];
    ...
    [self.leftButton setTitle:NSLocalizedString(@"Register", nil) forState:UIControlStateNormal];
    [self.rightButton setTitle:NSLocalizedString(@"Login", nil) forState:UIControlStateNormal];
...
- (void)addAllConstraints {
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_overlayTitle, _leftButton, _rightButton, _pageControl, _gradientView,_frontLayerView,_backLayerView);
    NSMutableArray *constraints = [NSMutableArray array];
    
    
    //Overlay front and backLayer view
    [self.frontLayerView setTranslatesAutoresizingMaskIntoConstraints:NO];
    [constraints addObject:@"V:|-[_frontLayerView]-|"];
    [constraints addObject:@"H:|-[_frontLayerView]-|"];
    [self.backLayerView setTranslatesAutoresizingMaskIntoConstraints:NO];
    [constraints addObject:@"V:|-[_backLayerView]-|"];
    [constraints addObject:@"H:|-[_backLayerView]-|"];
